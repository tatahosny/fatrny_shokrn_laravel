...
import { ArrowLeft, Save, Image, Plus, Trash2, Tag, GraduationCap } from 'lucide-react';
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2 p-3.5 rounded-xl bg-indigo-500/10 border border-indigo-500/30 space-y-1.5">
                                ...
                                <input type="number" step="0.01" min="0" value={data.student_price} onChange={e => setData('student_price', e.target.value)}
                                    placeholder="مثال: 25.00 (يطبق فقط على الطلاب المعتمدين)"
                                ...
                                <p className="text-[11px] text-stone-400">إذا أردت تخصيص هذا الصنف بعرض طلابي، حدد سعره المخفض هنا.</p>
