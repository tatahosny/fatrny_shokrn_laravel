...
export default function Index({ orders, restaurant, filters, counts, available_drivers = [] }: OrdersIndexProps) {
    ...
    const confirmWithDeliveryFee = (delivery_fee: number) => {
        ...
        router.patch(`/restaurant/orders/${confirmingOrder.id}/status`, { status: 'CONFIRMED', delivery_fee }, { preserveScroll: true });
    ...
    return (
        <>
            <Head title="إدارة الطلبات الواردة — بوابة المطعم — فطرنا" />
                            ...
                            return (
                                ...
                                >
                                    <div>
                                            ...
                                            <div className="space-y-1 border-t sm:border-t-0 sm:border-r border-stone-200 dark:border-stone-700 pt-2 sm:pt-0 sm:pr-3">
                                                ...
                                                {driver ? (
                                                    ...
                                                    <div className="pt-0.5">
                                                        <span className="text-[11px] text-purple-600 dark:text-purple-400 font-bold block mb-1">
                                                            جاهز — بانتظار الطيار
                                                        </span>
                                                        <button
                                                            type="button"
                                                            onClick={() => setAssigningOrderId(order.id)}
                                                            className="px-2.5 py-1 rounded-xl bg-purple-50 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-300 hover:bg-purple-100 text-[11px] font-bold transition flex items-center gap-1 cursor-pointer"
                                                        >
                                                    ...
                                                    <div className="pt-0.5">
                                                        <span className="text-[11px] text-stone-400 dark:text-stone-500 font-medium block">
                                                            قيد الإعداد بالمطبخ
                                                        </span>
                                        ...
                                        {assigningOrderId === order.id && order.status === 'READY_FOR_PICKUP' && (
